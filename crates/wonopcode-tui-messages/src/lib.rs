...
impl MessagesWidget {
    ...
    fn render_read_output(
        ...
        let language = wonopcode_tui_render::syntax::language_from_path(file_path);
        ...
        if !language.is_empty() {
            ...
            let highlighted = wonopcode_tui_render::syntax::highlight_code(&code, language, theme);
            ...
            if let Some(preview) = metadata.get("preview").and_then(|v| v.as_str()) {
                ...
                if !language.is_empty() {
                    let code: String = preview_lines
                        ...
                        .join("\n");
                    let highlighted =
                        wonopcode_tui_render::syntax::highlight_code(&code, language, theme);
